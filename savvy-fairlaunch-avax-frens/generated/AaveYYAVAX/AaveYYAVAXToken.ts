...
export class AaveYYAVAXToken extends ethereum.SmartContract {
  static bind(address: Address): AaveYYAVAXToken {
    return new AaveYYAVAXToken("AaveYYAVAXToken", address);
  }
