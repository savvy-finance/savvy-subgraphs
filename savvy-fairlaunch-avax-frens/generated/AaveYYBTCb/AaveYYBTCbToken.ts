...
export class AaveYYBTCbToken extends ethereum.SmartContract {
  static bind(address: Address): AaveYYBTCbToken {
    return new AaveYYBTCbToken("AaveYYBTCbToken", address);
  }
