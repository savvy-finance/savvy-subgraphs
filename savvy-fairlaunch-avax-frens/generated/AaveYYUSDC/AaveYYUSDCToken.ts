...
export class AaveYYUSDCToken extends ethereum.SmartContract {
  static bind(address: Address): AaveYYUSDCToken {
    return new AaveYYUSDCToken("AaveYYUSDCToken", address);
  }
