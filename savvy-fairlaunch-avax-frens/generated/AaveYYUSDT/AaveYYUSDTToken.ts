...
export class AaveYYUSDTToken extends ethereum.SmartContract {
  static bind(address: Address): AaveYYUSDTToken {
    return new AaveYYUSDTToken("AaveYYUSDTToken", address);
  }
