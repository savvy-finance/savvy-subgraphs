...
export class BenqiYYAVAXToken extends ethereum.SmartContract {
  static bind(address: Address): BenqiYYAVAXToken {
    return new BenqiYYAVAXToken("BenqiYYAVAXToken", address);
  }
