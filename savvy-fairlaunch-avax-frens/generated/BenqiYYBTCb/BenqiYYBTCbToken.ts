...
export class BenqiYYBTCbToken extends ethereum.SmartContract {
  static bind(address: Address): BenqiYYBTCbToken {
    return new BenqiYYBTCbToken("BenqiYYBTCbToken", address);
  }
