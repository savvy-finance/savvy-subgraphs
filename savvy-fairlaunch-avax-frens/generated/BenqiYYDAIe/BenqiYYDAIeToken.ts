...
export class BenqiYYDAIeToken extends ethereum.SmartContract {
  static bind(address: Address): BenqiYYDAIeToken {
    return new BenqiYYDAIeToken("BenqiYYDAIeToken", address);
  }
