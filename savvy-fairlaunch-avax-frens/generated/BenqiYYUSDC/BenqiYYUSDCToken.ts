...
export class BenqiYYUSDCToken extends ethereum.SmartContract {
  static bind(address: Address): BenqiYYUSDCToken {
    return new BenqiYYUSDCToken("BenqiYYUSDCToken", address);
  }
