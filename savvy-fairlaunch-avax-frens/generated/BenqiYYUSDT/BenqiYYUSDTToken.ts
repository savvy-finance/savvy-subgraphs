...
export class BenqiYYUSDTToken extends ethereum.SmartContract {
  static bind(address: Address): BenqiYYUSDTToken {
    return new BenqiYYUSDTToken("BenqiYYUSDTToken", address);
  }
