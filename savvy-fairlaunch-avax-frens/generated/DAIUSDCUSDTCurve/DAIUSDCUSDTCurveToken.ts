...
export class DAIUSDCUSDTCurveToken extends ethereum.SmartContract {
  static bind(address: Address): DAIUSDCUSDTCurveToken {
    return new DAIUSDCUSDTCurveToken("DAIUSDCUSDTCurveToken", address);
  }
