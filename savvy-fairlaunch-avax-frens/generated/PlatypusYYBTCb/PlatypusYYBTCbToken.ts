...
export class PlatypusYYBTCbToken extends ethereum.SmartContract {
  static bind(address: Address): PlatypusYYBTCbToken {
    return new PlatypusYYBTCbToken("PlatypusYYBTCbToken", address);
  }
