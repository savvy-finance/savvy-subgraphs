...
export class USDCUSDCePangolinToken extends ethereum.SmartContract {
  static bind(address: Address): USDCUSDCePangolinToken {
    return new USDCUSDCePangolinToken("USDCUSDCePangolinToken", address);
  }
