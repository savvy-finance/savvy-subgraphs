...
export class USDCUSDCeTJToken extends ethereum.SmartContract {
  static bind(address: Address): USDCUSDCeTJToken {
    return new USDCUSDCeTJToken("USDCUSDCeTJToken", address);
  }
