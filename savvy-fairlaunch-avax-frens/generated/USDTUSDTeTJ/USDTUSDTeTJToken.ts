...
export class USDTUSDTeTJToken extends ethereum.SmartContract {
  static bind(address: Address): USDTUSDTeTJToken {
    return new USDTUSDTeTJToken("USDTUSDTeTJToken", address);
  }
