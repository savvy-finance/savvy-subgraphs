...
import { SavvyFrontendInfoAggregator } from "../generated/SavvyVeSVY/SavvyFrontendInfoAggregator";
import { SavvyVeSVY } from "../generated/SavvyVeSVY/SavvyVeSVY";
...
export const VESVY_CONTRACT_ADDRESS =
  "0x9aEEe4656F67034B06D99294062feBA1015430ad";
export const SFIA_CONTRACT_ADDRESS =
  "0x97DCA4000B2b89AFD926f5987ad7b054B3e39dB2";
...
CONTRACT_TO_NAME_MAP.set(
  "0x210c0856cd966fb8990b062488a18de778122329",
  "savvy-dao-arbitrum"
);
CONTRACT_TO_NAME_MAP.set(
  "0xdcb178d47ab77e50f76381606e920454e730c998",
  "savvy-proxy-arbitrum"
);
CONTRACT_TO_NAME_MAP.set(
  "0x4f54cab19b61138e3c622a0bd671c687481ec030",
  "savvy-treasury-arbitrum"
);
CONTRACT_TO_NAME_MAP.set(
  "0x04e1e0b8b3cab90d586b94fcf2976a73365156a1",
  "savvy-admin-arbitrum"
);
CONTRACT_TO_NAME_MAP.set(
  "0x4ff08f48a3fe2ce12b78b896a72d13bd5e9a0e32",
  "savvy-booster-arbitrum"
);
CONTRACT_TO_NAME_MAP.set(
  "0x8f7c5539abefee5b860737a7f8bfa7bb1aa1dd1e",
  "savvy-mining-arbitrum"
);
CONTRACT_TO_NAME_MAP.set(
  "0xc34da341a4ad2a40aa9282e692a500e023baabee",
  "savvy-ecosystem-arbitrum"
);
CONTRACT_TO_NAME_MAP.set(
  "0xc6fc35bc3d83e9fce4f52a6dbe62e8227a6ac83e",
  "savvy-unvested-seed-arbitrum"
);
CONTRACT_TO_NAME_MAP.set(
  "0xfd532461d2b080967a4827b066954a3e90b17d15",
  "savvy-unvested-team-arbitrum"
);
CONTRACT_TO_NAME_MAP.set(
  "0xa7ccba432d1d4861098f155341644e96a492224c",
  "savvy-hold-team-arbitrum"
);
CONTRACT_TO_NAME_MAP.set(
  "0x7754b5ccd22261c651f926b9eb8ee286f836cdd2",
  "savvy-peanut-admin-arbitrum"
);
...
export const veSVYContract = SavvyVeSVY.bind(
  Address.fromString(VESVY_CONTRACT_ADDRESS)
);
export const SFIAContract = SavvyFrontendInfoAggregator.bind(
  Address.fromString(SFIA_CONTRACT_ADDRESS)
);
